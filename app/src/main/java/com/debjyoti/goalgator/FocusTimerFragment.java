...
public class FocusTimerFragment extends Fragment {
    @BindView(R.id.minuteInput)
    EditText minuteInput;
    @BindView(R.id.restart)
    Button restart;
    @BindView(R.id.stop)
    Button stop;
    @BindView(R.id.minuteOutput)
    TextView minuteOutput;
    @BindView(R.id.alarmSelector)
    Spinner alarmSelector;
    @BindView(R.id.linear_focus_timer)
    LinearLayout linearFocusTimer;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        minuteInput = rootView.findViewById(R.id.minuteInput);
        restartButton = rootView.findViewById(R.id.restart);
        stopButton = rootView.findViewById(R.id.stop);
        alarmPicker = rootView.findViewById(R.id.alarmSelector);
        minuteOutput = rootView.findViewById(R.id.minuteOutput);
